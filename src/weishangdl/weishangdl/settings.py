"""
Django settings for weishangdl project.
...
WSGI_APPLICATION = 'weishangdl.wsgi.application'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'weishangdl.whoosh_cn_backend.WhooshEngine',
